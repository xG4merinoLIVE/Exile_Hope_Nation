...
(_display displayCtrl 4004) ctrlSetStructuredText (parseText (format ["<t align='center' font='RobotoMedium'>Base Marker</t>"]));
...
_Instruction ctrlSetStructuredText parseText "<t size='1' align='center'>Base Marker sichtbar machen... ( Sichtbar nur für dich )</t>";
...
fnc_markerOn = {
		...
		["Success",["Base Marker ist nun sichtbar."]] call ExileClient_gui_notification_event_addNotification;
};
...
fnc_markerOff = {
		...
		forEach (allMissionObjects "Exile_Construction_Flag_Static");
		(findDisplay 24015) closeDisplay 0;
		["Whoops",["Base Marker nicht mehr sichtbar."]] call ExileClient_gui_notification_event_addNotification;
