...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_skill_static					= [["aimingAccuracy",0.10],["aimingShake",0.40],["aimingSpeed",0.25],["spotDistance",0.50],["spotTime",0.50],["courage",0.75],["reloadSpeed",0.75],["commanding",0.50],["general",0.75]];	// Static AI Skills
	DMS_ai_skill_easy					= [["aimingAccuracy",0.15],["aimingShake",0.50],["aimingSpeed",0.25],["spotDistance",0.50],["spotTime",0.50],["courage",0.75],["reloadSpeed",0.75],["commanding",0.50],["general",0.75]];	// Easy
	DMS_ai_skill_moderate				= [["aimingAccuracy",0.30],["aimingShake",0.60],["aimingSpeed",0.25],["spotDistance",0.50],["spotTime",0.50],["courage",0.75],["reloadSpeed",0.75],["commanding",0.50],["general",0.75]];	// Moderate
	DMS_ai_skill_difficult				= [["aimingAccuracy",0.35],["aimingShake",0.70],["aimingSpeed",0.25],["spotDistance",0.50],["spotTime",0.50],["courage",0.75],["reloadSpeed",0.75],["commanding",0.50],["general",0.75]]; 	// Difficult
	DMS_ai_skill_hardcore				= [["aimingAccuracy",0.50],["aimingShake",0.90],["aimingSpeed",0.50],["spotDistance",0.75],["spotTime",0.75],["courage",0.75],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Hardcore
